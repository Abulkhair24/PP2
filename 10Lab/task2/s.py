...
class Snake(pygame.sprite.Sprite):
    ...
    def draw_block(self, color, x, y, main_screen):
        pygame.draw.rect(main_screen, color, (x * self.size_block, y * self.size_block, self.size_block, self.size_block))
    ...
    def build_eda(self):
        ...
        self.main_screen.blit(self.text_of_score_eda, (self.size_block * self.steak[0] + 3, self.size_block * self.steak[1] - 3))
